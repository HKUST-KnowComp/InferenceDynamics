...
def compute_solve_rate(responses: list[str], solutions: list[str]):
  ...
  for r, s in zip(responses, solutions):
    ...
    if (
      ...
      solved_list.append(1.0)
    else:
      solved_list.append(0.0)
  return solved_list, sum(solved_list) / len(solved_list)
...
def main(_):
  ...
  solved_list, overall_solved_rate = compute_solve_rate(responses, solutions)
  print(
